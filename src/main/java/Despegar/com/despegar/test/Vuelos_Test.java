...
public class Vuelos_Test extends Configuracion {
	...
	@Test(dataProvider = "vuelos", dataProviderClass = DataProviderPrueba.class,
			groups = "PROBANDO_GRUPO", testName = "Buesqueda de Vuelos",
			description = "Esta es una prueba que realiza la busqueda de vuelos por parametros desde una Dataprovider")
